        ...
        <div class="center-content">
            ...
            <div id="DataButtonMode">
                <div id="HistoryDisplay">
                     ...
                     <?php
                    $tableConfigs = array(
                        ['system_sn' => 'res_data_all', 'label' => $text['data_history_success'], 'data' => $data['res_data'], 'display' => 'block'],
                        ['system_sn' => 'res_data_ok', 'label' => $text['data_history_success'], 'data' => $data['res_data_ok'], 'display' => 'none'],
                        ['system_sn' => 'res_data_nok', 'label' => $text['data_history_fail'], 'data' => $data['res_data_nok'], 'display' => 'none']
                    );
                        ...
                        <div class="table-container" id="<?php echo $config['id']; ?>" style="display: <?php echo $config['display']; ?>;">
                            ...
                            <div class="scrollbar" id="style-data">
                                <table class="table w3-table w3-hoverable">
                                    ...
                                    <tbody id="<?php echo $config['system_sn']; ?>_tbody" style="font-size: 16px; text-align: center;">
