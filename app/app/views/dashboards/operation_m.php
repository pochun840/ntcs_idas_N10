    ...
    <div class="main-content">
        <div class="center-content">
            <div class="topnav">
                ...
                <input type="text" id="Job_Name" name="Job_Name" size="10" maxlength="20"  readonly>

                <label style="color: #fff;" for="seq_name"><?php echo  $data['text']['sequence'];?>:</label>
                <input type="text" id="Seq_Name" name="Seq_Name" size="10" maxlength="20" readonly>

                <label style="color: #fff;" for="screw"><?php echo  $data['text']['screws'];?>:</label>
                <input type="text" id="Screws" name="Screws" size="4" maxlength="20"    readonly>
            </div>
