    ...
    <div class="row t2">
        ...
        <div class="col t2">
            <form id="edit_password" onsubmit="set_password();return false;" method="get">
                <input type="password" id="new_password" placeholder="<?php echo $text['system_new_password']; ?>" size="18" maxlength="10" required class="t3 form-control"  oninput="value=value.replace(/[^\d]/g,'')">
                <input type="password" id="comfirm_password" placeholder="<?php echo $text['system_confirm_password']; ?>" size="18" maxlength="10" class="t3 form-control"  oninput="value=value.replace(/[^\d]/g,'')">
                <input type="submit" value="<?php echo $text['save']; ?>" class="all-btn w3-submit w3-border w3-round-large" style="float: right; margin-right: 5px">
            </form>
        </div>
    </div>
