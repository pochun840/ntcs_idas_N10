<div id="iDas-Update_Setting" class="divMode" style="display: none;">
    <div class="col t1" style="padding-top: 5%; margin-left: 6%"><?php echo $text['system_idas_current_version'];?>:</div>
    <div class="row t2">
    ...
    <div class="col t1" style="margin-left: 6%"><?php echo $text['system_idas_upload_file'];?>:</div>
    <div class="row t2">
        <div class="col t2" style="margin-left: 10%">
