...
<div class="container-ms">
    ...
    <div class="main-content">
        <div class="center-content">
            ...
            <!-- idas_controller OP -->
                <?php require_once '../app/views/setting/controller_setting_m.php';?>
            <!-- idas_controller ED -->


            <!-- idas_system OP -->
                <?php require_once '../app/views/setting/system_setting_m.php';?>
            <!-- idas_system ED -->
               
                                        
            <!-- idas_barcode OP -->
                <?php require_once '../app/views/setting/barcode_setting_m.php';?>
            <!-- idas_barcode ED -->
