<div id="System_Setting"  class="divMode" style="display: none;">
    <div class="col t1" style="padding-left: 0%;font-weight: bold; padding-top: 1%;"><?php echo $text['system_setting'];?></div>
    <div class="setting_scrollbar" id="style-setting">
        <div class="setting_force-overflow">
            ...
            <div class="row t2">
                <div class="col-6 t1"><?php echo $text['system_disc_space']; ?>:</div>
                <div class="col t2">
