...
<div class="container-ms">
    ...
    <form class="pt-4" action="?url=Logins" method="POST">
      ...
      <select class="input_name" name="username">
...
<!-- <footer style=" bottom: 0; left: 0; position: fixed; right: 0; z-index: 1032; color: white; ">
    <div style="float: right;padding-right: 5px;">
        <b>Version</b> <//?php echo $data['iDas_Vesion']; ?>
    </div>
    <strong style="padding-left: 5px;"><a href="?url=Licenses">Licenses</a></strong>
</footer> -->
...
input[type=text],
input[type=password],.input_name
{
    background: #fff;
    border: none;
    border-radius: 8px;
