...
class Database
{
    ...
    public function __construct()
    {
        ...
        $sourceBase = $isLinux && !$isLocal ? '/home/kls/NTCS10/' : '../';
        ...
        $db_paths = [
            'data'        => ($isLinux && !$isLocal) 
                                ? '/home/kls/NTCS10/ntcs_data2025.db' 
                                : BASE_PATH . 'ntcs_data2025.db',
            'iDas'        => BASE_PATH . 'KLS_NTCS_IDAS.Lin',
            'iDas_login'  => BASE_PATH . 'das.db',
            'ntcs_device' => BASE_PATH . 'ntcs_device.db',
        ...
        // echo "db_data path: " . ($isLinux && !$isLocal 
        //     ? '/home/kls/NTCS10/ntcs_data2025.db' 
        //     : BASE_PATH . 'ntcs_data2025.db') . "<br>";
    }
    ...
    public function getDb_das_device()  { return $this->db_ntcs_device ?? null; }
