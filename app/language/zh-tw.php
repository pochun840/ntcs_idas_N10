...
$text['please_select_job'] = "請選擇一個工作";
$text['please_select_seq'] = "請選擇一個序列";
$text['please_select_step'] = "請選擇一個步驟";
$text['please_select_input'] = "請選擇一個輸入";
$text['please_select_output'] = "請選擇一個輸出";
...
// Seq type
$text['sequence_type'][1] = '鎖附';
$text['sequence_type'][2] = '訊息';
$text['sequence_type'][3] = '延遲';
$text['sequence_type'][4] = '輸入';
$text['sequence_type'][5] = '輸出';

// Seq table
$text['seq_id'] = '工序ID';
$text['seq_name'] = '工序名稱'; // Mobile
$text['sequence_name'] = '工序名稱'; //PC
$text['target_type'] = '工序目標';
$text['tighten_repeat'] = '顆數'; // Mobile
$text['tightening_repeat'] = '顆數';
$text['enable'] = '啟用';
$text['disable'] = '禁用';
$text['seq_enable'] = '啟用'; //mobile
$text['up'] = '上';
$text['down'] = '下';
...
// Seq Fastening
$text['seqtype'] = '序列類型'; // PC
$text['seq_type'] = '序列類型'; // Mobile
$text['new_seq'] = '新增工序';
$text['edit_seq'] = '編輯工序';
$text['del_seq'] = '刪除工序';
...
// Seq Message
$text['text_message'] = '文字訊息';
$text['imgText_message'] = '圖片訊息';

// Seq Delay
$text['Text_Delaytime'] = '延遲時間';

// Seq Input
$text['Input_Setting'] = '輸入設定';

// Seq Output
$text['Impulse_Setting'] = '脈衝設定';
$text['Impulse_Signal'] = '脈街訊號周期 (毫秒)';
...
$text['system_db_language_diff'] = '因控制器語系變更，更新後請重新啟動控制器';
$text['system_hex_update_notice'] = '更新後控制器將自動重開機\n請確認是否要進行更新';
...
$text['system_barcode_mode_1'] = '條碼停止';//BS
$text['system_barcode_mode_2'] = '條碼停止(可跳工序)';//BS (free)
$text['system_barcode_mode_3'] = '切換工作/工序';//Switch Job / Seq
...
$text['system_agent_ip'] = '代理IP';
$text['system_agent_type'] = '代理類型';
...
$text['system_idas_match_version'] = '對應控制器版本';
$text['system_idas_upload_file'] = '上傳檔案';
$text['system_idas_update'] = '更新';
...
$text['img_load'] = '../public/img/home_load_tw.png';
$text['img_load_hover'] = '../public/img/home_m_load_tw.png';

$text['img_save'] = '../public/img/home_save_tw.png';
$text['img_save_hover'] = '../public/img/home_m_save_tw.png';
...
if(isset($data['tool_info'])){
	$error_message['unfasten_RPM'] = '超出範圍 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
...
$error_message['Pre_Run_RPM'] = '超出範圍 60 - max_rpm';
$error_message['Pre_Run_Angle'] = '超出範圍 1 - 30600';
$error_message['Target_Angle'] = '超出範圍 1 - 30600';
if(isset($data['tool_info']))
{
	// $error_message['Hi_Torque'] = '需大於 Target_Torque 且小於'.$data['tool_info']['max_torq'];
	...
	$error_message['Target_Torque'] = '超出範圍 '.$data['tool_info']['min_torque'].' - '.$data['tool_info']['max_torque'];
	$error_message['Run_Down_Speed'] = '超出範圍 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Pre_Run_RPM'] = '超出範圍 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];

	$error_message['Run_Down_Speed'] = '超出範圍 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Joint_OffSet'] = '超出範圍 ';
	$error_message['Downshift_Speed'] = '超出範圍 '.$data['tool_info']['min_rpm'].' - 小於'.$text['Run_Down_Speed'];
}
...
if(isset($data['tool_info'])){
	$error_message['Pre_Run_RPM'] = '超出範圍 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Torque_Window_Add'] = '超出範圍 '.$data['tool_info']['min_torque'].' - '.round($data['tool_info']['max_torque']*1.1,4) ;
