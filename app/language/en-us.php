...
// alert 
$text['please_select_job'] = "Please select a job";
$text['please_select_job'] = "Please select a job";
$text['please_select_seq'] = "Please select a sequence";
$text['please_select_step'] = "Please select a step";
$text['please_select_input'] = "Please select a input";
$text['please_select_output'] = "Please select a output";
...
// Seq type
$text['sequence_type'][1] = 'Fastening';
$text['sequence_type'][2] = 'Message';
$text['sequence_type'][3] = 'Delay';
$text['sequence_type'][4] = 'Input';
$text['sequence_type'][5] = 'Output';

// Seq table
$text['seq_id'] = 'Seq ID';
$text['seq_name'] = 'Seq Name'; // Mobile
$text['sequence_name'] = 'Sequence Name'; //PC
$text['target_type'] = 'Target Type';
$text['tighten_repeat'] = 'TR'; // Mobile
$text['tightening_repeat'] = 'Tightening Repeat'; // PC
$text['enable'] = 'Enable';
$text['disable'] = 'Disable';
$text['seq_enable'] = 'Ena'; //mobile
$text['up'] = 'Up';
$text['down'] = 'Down';
...
// Seq Fastening
$text['seqtype'] = 'Sequence Type'; // PC
$text['seq_type'] = 'Seq Type'; // Mobile
...
$text['OK_Sequence_Stop'] = 'Sequence Stop';
$text['OK_Seq'] = 'OK Seq'; // mobile
$text['Seq_Stop'] = 'Seq Stop'; // mobile
...
// Seq Message
$text['text_message'] = 'Text Message';
$text['imgText_message'] = 'Image Message';

// Seq Delay
$text['Text_Delaytime'] = 'Delay Time';

// Seq Input
$text['Input_Setting'] = 'Input Setting';

// Seq Output
$text['Impulse_Setting'] = 'Impulse Setting';
$text['Impulse_Signal'] = 'Impulse signal duration (ms)';
...
$text['High_Angle'] = 'High Angle ( &#870; )';
$text['Low_Angle'] = 'Low Angle ( &#870; )';
...
$text['Threshold_Type'] = 'Threshold Mode';
...
$text['Downshift_Mode'] = 'Downshift';
$text['Downshift_Torque'] = 'Downshift Torque';
$text['Downshift_Angle'] = 'Downshift Angle';
...
$text['Choose_option'] = 'Choose option';
...
$text['Start-IN'] = 'Start IN';
$text['Unscrew(Remote)'] = 'Unscrew';
...
//Controller Setting
$text['system_id'] = 'Device ID';
$text['system_name'] = 'Device Name';
$text['system_diskfull_warning'] = 'Storage Wraning (%)';
$text['system_torque_filter'] = 'Torque Filter (N.m)';
$text['sample_rate'] = 'Sampling Rate';
$text['system_unit'] = 'Torque Unit';
...
$text['system_db_language_diff'] = 'Due to the language change of the controller, please restart the controller after updating';
$text['system_hex_update_notice'] = 'The controller will automatically restart after the update\nPlease confirm whether you want to update';
...
$text['system_barcode_match_from'] = 'From';
$text['system_barcode_match_to'] = 'Count';
$text['system_barcode_count'] = 'Count';//mobile
...
$text['system_barcode_mode_1'] = 'BS';//BS
$text['system_barcode_mode_2'] = 'BS (free)';//BS (free)
$text['system_barcode_mode_3'] = 'Switch Job / Seq';//Switch Job / Seq
...
$text['system_agent_ip'] = 'Agent IP';
$text['system_agent_type'] = 'Agent Type';
...
$text['system_idas_match_version'] = 'Match Controller Version';
$text['system_idas_upload_file'] = 'Upload file';
$text['system_idas_update'] = 'Update';
...
if(isset($data['tool_info'])){
	$error_message['unfasten_RPM'] = 'Out of range'.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['unfasten_force'] = 'Out of range 50 - 1000';
}
...
$error_message['Pre_Run_RPM'] = 'Out of range 60 - max_rpm';
$error_message['Pre_Run_Angle'] = 'Out of range 1 - 30600';
$error_message['Target_Angle'] = 'Out of range 1 - 30600';
if(isset($data['tool_info'])){
	// $error_message['Hi_Torque'] = 'Needs to be greater than Target_Torque and less than'.$data['tool_info']['max_torq'];
	...
	$error_message['Target_Torque'] = 'Out of range '.$data['tool_info']['min_torque'].' - '.$data['tool_info']['max_torque'];
	$error_message['Run_Down_Speed'] = 'Out of range '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Pre_Run_RPM'] = 'Out of range '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];

	$error_message['Run_Down_Speed'] = 'Out of range '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Joint_OffSet'] = 'Out of range';
	$error_message['Downshift_Speed'] = 'Out of range '.$data['tool_info']['min_rpm'].' - less than '.$text['Run_Down_Speed'];
}
...
if(isset($data['tool_info'])){
	$error_message['Pre_Run_RPM'] = 'Out of range '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Torque_Window_Add'] = 'Out of range '.$data['tool_info']['min_torque'].' - '.round($data['tool_info']['max_torque']*1.1,4) ;
