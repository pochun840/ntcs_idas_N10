...
$text['please_select_job'] = "请选择一个工作";
$text['please_select_seq'] = "请选择一个序列";
$text['please_select_step'] = "请选择一个步骤";
$text['please_select_input'] = "请选择一个输入";
$text['please_select_output'] = "请选择一个输入";
...
// Seq type
$text['sequence_type'][1] = '锁附';
$text['sequence_type'][2] = '讯息';
$text['sequence_type'][3] = '延迟';
$text['sequence_type'][4] = '输入';
$text['sequence_type'][5] = '输出';

// Seq table
$text['seq_id'] = '工序ID';
$text['seq_name'] = '工序名称'; // Mobile
$text['sequence_name'] = '工序名称'; //PC
$text['target_type'] = '工序目标';
$text['tighten_repeat'] = '颗数'; // Mobile
$text['tightening_repeat'] = '颗数';
$text['enable'] = '启用';
$text['disable'] = '禁用';
$text['seq_enable'] = '启用'; //mobile
$text['up'] = '上';
$text['down'] = '下';
...
// Seq Fastening
$text['seqtype'] = '序列类型'; // PC
$text['seq_type'] = '序列类型'; // Mobile
$text['new_seq'] = '新增工序';
$text['edit_seq'] = '编辑工序';
$text['del_seq'] = '刪除工序';
...
// Seq Message
$text['text_message'] = '文字讯息';
$text['imgText_message'] = '图片讯息';

// Seq Delay
$text['Text_Delaytime'] = '延迟时间';

// Seq Input
$text['Input_Setting'] = '输入设定';

// Seq Output
$text['Impulse_Setting'] = '脉冲设定';
$text['Impulse_Signal'] = '脉街讯号周期 (毫秒)';
...
$text['Monitor torque by window'] = '监控扭力视窗';
$text['Monitor angle by window']  = '监控角度视窗';
$text['Upper_text'] = '上限';
$text['Lower_text'] = '下限';
...
$text['tool_type'] = '型号';
$text['tool_sn'] = '序号';
$text['sw_version'] = '软体版本';
$text['fw_version'] = '韧体版本';
...
$text['system_db_language_diff'] = '因控制器语系变更，更新后请重新启动控制器';
$text['system_hex_update_notice'] = '更新后控制器将自动重开机\n请确认是否要进行更新';
...
$text['system_barcode_count'] = '位数';//mobile
...
$text['system_agent_ip'] = '代理 IP';
$text['system_agent_type'] = '代理类型';
...
$text['system_idas_match_version'] = '匹配控制器版本';
...
if(isset($data['tool_info'])){
	$error_message['unfasten_RPM'] = '超出范围 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
...
$error_message['Pre_Run_RPM'] = '超出范围 60 - max_rpm';
$error_message['Pre_Run_Angle'] = '超出范围 1 - 30600';
$error_message['Target_Angle'] = '超出范围 1 - 30600';
if(isset($data['tool_info'])){
	// $error_message['Hi_Torque'] = '需大于 Target_Torque 且小于'.$data['tool_info']['max_torq'];
	...
	$error_message['Target_Torque'] = '超出范围 '.$data['tool_info']['min_torque'].' - '.$data['tool_info']['max_torque'];
	$error_message['Run_Down_Speed'] = '超出范围 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Pre_Run_RPM'] = '超出范围 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];

	$error_message['Run_Down_Speed'] = '超出范围 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Joint_OffSet'] = '超出范围 ';
	$error_message['Downshift_Speed'] = '超出范围 '.$data['tool_info']['min_rpm'].' - 小于'.$text['Run_Down_Speed'];
}
...
if(isset($data['tool_info'])){
	$error_message['Pre_Run_RPM'] = '超出范围 '.$data['tool_info']['min_rpm'].' - '.$data['tool_info']['max_rpm'];
	$error_message['Torque_Window_Add'] = '超出范围 '.$data['tool_info']['min_torque'].' - '.round($data['tool_info']['max_torque']*1.1,4) ;
