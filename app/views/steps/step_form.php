<link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>css/add_step.css">
<style type="text/css">
    .form-control
    {
...
<div class="container-ms">
    <div class="w3-text-white w3-center">
        <table class="no-border">
            <tr id="header">
                <td width="100%"><h3><?php echo ($data['type'] == 'edit') ? $text['edit_step']  : $text['new_step']; ?></h3></td>
            </tr>
        </table>
    </div>
    ...
    <div class="main-content">
        <div class="center-content">
            ...
            <div class="new-container">
                <div class="scrollbar" id="style-newStep" style="margin-bottom: 10px;">
                        ...
                        <div class="row" style="background-color: #F2F1F1;">
                            <div class="col-md-6 t2">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    ...
                                    <div class="col-9">
                                        <select id="StepOption" onchange="updateLabel()" style="width: 180px">
                                            <?php 
                                                    $options = array(
                                                        1 => $text['Torque'],
                                                        2 => $text['Angle'],
                            ...
                            <div class="col-md-6 t2">
                                ...
                                <div class="col-12 row t2 mt-3 ps-4">
                                    <div class="col-4"><?php echo $text['Downshift_Mode'];?>:</div>
                                    <div class="col-8">
                                        <div class="form-check form-check-inline ">
                                ...
                                <div id="downshift_block" class="col-12 row t2 mt-3 ps-4">
                                    <div class="col-4" id="show_downshift_torque" style="display:none;" ><?php echo $text['Downshift_Torque'];?> (<?php echo $text[$data['torque_unit']]; ?>):</div>
            ...
            <div class="w3-center" style="margin: 10px 0px; margin-bottom: 10px;">
                <button style="height:50px;width:100px;font-size:25px" id="button1" class="button-save" onclick="save_or_edit_step(<?php echo (int)($data['type'] == 'edit'); ?>)"><?php echo $text['save']; ?></button>
            </div>
        </div>
    </div>
