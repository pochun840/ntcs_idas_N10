<link rel="stylesheet" type="text/css" href="<?php echo URLROOT; ?>css/job_m.css">
                ...
                <div class="scrollbar" id="style-jobtable">
                    <div class="force-overflow">
                        <table id="job_table"  class="table w3-table">
                            <thead id="header-table" style="font-size: 2.8vmin;text-align: center;">
                            ...
                            <tbody style="font-size: 2.5vmin;text-align: center;">
								<?php foreach ($data['jobs'] as $key => $value) {?>
								    <tr>
										...
										<td><?php echo $value['JOBname'];?></td>
										<td><?php echo $value['total_seq'];?></td>
                                        <?php $url ='?url=Sequences/index/'.$value['JOBID'];?>
            ...
            <div class="modal-content w3-animate-zoom" style="width: 100%">
                <header class="w3-container modal-header">
                    <span onclick="closebutton('newjob');"
                        class="w3-button w3-red w3-display-topright" style="width: 50px; height:43px; margin: 3px; font-size: 18px;">&times;</span>
                    ...
                    <form id="new_job_form">
        			    ...
        			    <div style="padding-left: 5%;">
        				    ...
        				    <div class="row">
        				        ...
        				        <div class="t2 col-5">
        				            <input type="text" class="form-control" id="to_job_name"  value ='<?php echo "JOB-".$data['jobint'];?>'>
        				        </div>
        				    </div>
        			    </div>
        			  </form>
