             ...
             <div class="new-container">
                <div style="background-color: #F2F1F1">
                    ...
                    <div class="mx-auto" style="max-width: 700px; width: 100%;">
                        ...
                        <!-- Sequence Name -->
                        <div class="row align-items-center" style="padding-left: 5%; padding-top: 1%; margin-bottom: 5px;">
                            <div class="col-4 text-end t1"><?php echo $text['seq_name'];?>:</div>
                            <div class="col-7">
                        ...
                        <div class="scrollbar-input-pin" id="style-input-pin">
                            <div class="force-overflow-input-pin">
                                <table id="InputNew_Modal" class="table w3-table text-center mb-4" style="background-color: #FFFFFF">
                                    <thead id="header-table" style="font-size:17px; background-color:rgb(218, 235, 248)">
                                        <tr>
                                    ...
                                    <tbody class="text-center" style="font-size:17px;">
                                        <?php
                                            $check = false;
                                            for ($i=1; $i <= 11; $i++) { 
                                                echo '<tr>';
                                ...
                                <!-- Input Setting -->
                                <div class="row t2 align-items-center" style="padding-left: 2%;">
                                    <div class="col t2"><?php echo $text['Impulse_Setting'];?>:<img style="max-width: 80px;" src="../public/img/signal02.png"></div>
                                </div>
                                <div class="row t2 align-items-center" style="padding-left: 2%;">
                                    <div class="col t2"><?php echo $text['Impulse_Signal'];?> :
