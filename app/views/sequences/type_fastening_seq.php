...
<style type="text/css">
    .form-control{ width: auto!important;display: initial!important;}
    ...
    <div class="main-content">
        <div class="center-content">
            <div class="topnav">
                ...
                <input type="text" id="job_id" name="job_id" size="8" maxlength="20" value="<?php echo $data['job_id'];?>" readonly
                ...
                <input type="text" id="seq_id" name="seq_id" size="8" maxlength="20" value="<?php echo $data['seq_id'];?>" readonly
                style="height:28px; font-size:20px;text-align: center; background-color: #DDDDDD; border:0; margin: 3px;">
                        ...
                        <div class="row" style="background-color: #F2F1F1;">
                            <div class="col-md-6">
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['sequence_name'];?> :</div>
                                    <div class="col-9 t2">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['tightening_repeat'];?> :</div>
                                    <div class="col-9 t2">
                                        <input id="tightening_repeat" name="seq_repeat" class="form-control" value="1">
                                        <div class="invalid-feedback"></div> (1-99)
                                    </div>
                                </div>
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['Timeout'];?> (<?php echo $text['Second'];?>) :</div>
                                    <div class="col-9 t2">
                                ...
                                <!-- trường hiển thị riêng cho type Delay delay time, thông báo khi delay time trống -->
                                <input type="hidden" id="seq_type" value="<?php echo $type; ?>">

                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['DT_Time'];?> (<?php echo $text['Second'];?>) :</div>
                                    <div class="col-9 t2">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['TT_Time'];?> (<?php echo $text['Second'];?>) :</div>
                                    <div class="col-9 t2">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['OK-Sequence'];?> :</div>
                                    <div class="col-9 t2">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['OK_Sequence_Stop'];?> :</div>
                                    <div class="col-9 t2">
                                        <div class="form-check form-check-inline ">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['NG_Stop'];?> :</div>
                                    <div class="col t2 d-flex align-items-center">
                                        <select id="ng_stop" class="form-select" style="font-size: 14px; width: 210px;">
                                        <?php 
                                            for ($i = 0; $i <= 9; $i++) {
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['Accumulate_Angle'];?> :</div>
                                    <div class="col-9 t2">
                                        <div class="form-check form-check-inline ">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['total_high_angle'];?>:</div>
                                    <div class="col-9 t2">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['total_low_angle'];?>:</div>
                                    <div class="col-9 t2">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['Angle_Calculation'];?> (<?php echo $text['step'];?>) :</div>
                                    <div class="col-9 t2">
                                        <?php for ($i = 1; $i <= 5; $i++) { ?>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input thread-checkbox" 
                                                    type="checkbox" 
                                                    id="Thread_Calcu_<?php echo $i; ?>" 
                                                    value="<?php echo $i; ?>" 
