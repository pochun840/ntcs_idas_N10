                    ...
                    <div class="force-overflow">
                        <div class="row" style="background-color: #F2F1F1;">
                            <div class="col-md-6 t2">
                                ...
                                <div class="col-12 row t2 mt-3">
                                    <div class="col-3 t1"><?php echo $text['imgText_message'];?> :</div>
                                    <div class="col-9 t2">
                                        <select id="img_list" class="form-select" style="width: auto;">
                                            <option value="-">-</option>
                            ...
                            <div class="col-md-6 t2">
                                <div class="col-12 row t2 mt-3" style="height:90%;border: solid;border-color: #d3d3d3;display: flex;align-items: center;border-radius: 10px;justify-content: center;">
                                    <img id="select_img" src="" style="height: 90%;width:auto;border: none;">
                                </div>
                            </div>
                        </div>
                    </div>
