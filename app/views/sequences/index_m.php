    ...
    <div class="main-content">
        <div class="center-content">
			<div class="topnav">
                ...
                <input type="text" id="job_id" name="job_id" size="10" maxlength="20" value="<?php echo $data['job_id'];?>" readonly
                		...
                		<table id="seq_table" class="table w3-table">
                			<thead id="header-table" style="font-size: 2.8vmin;text-align: center;">
                				<tr class="w3-dark-grey">
                	                ...
                	                <th><?php echo $text['tighten_repeat']; ?></th>
                	                <th><?php echo $text['seq_enable']; ?></th>
