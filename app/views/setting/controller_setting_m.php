<div id="Controller_Setting" class="divMode">
    <div class="col t1" style="padding-left: 0%;font-weight: bold; padding-top: 1%"><?php echo $text['controller_setting'];?></div>
    <div class="setting_scrollbar" id="style-setting">
        <div class="setting_force-overflow">
            ...
            <div class="row t2">
                <div class="col-6 t1"><?php echo $text['sample_rate']; ?> :</div>
                <div class="col t2">
            ...
            <div class="col t1" style="padding-left: 2%;font-weight: bold; padding-top: 1%"><?php echo $text['Downshift'];?></div>
            ...
            <div class="col t1" style="padding-left: 0%;font-weight: bold; padding-top: 1%"><?php echo $text['Button_Access_With_Password_text'];?></div>
            ...
            <div class="col t1" style="padding-left: 0%;font-weight: bold; padding-top: 1%"><?php echo $text['Background_Color_text'];?></div>
