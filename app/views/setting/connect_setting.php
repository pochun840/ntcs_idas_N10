<div id="Connect_Setting" class="divMode" style="display: none">
    ...
    <div class="col t1" style="margin-left: 6%"><?php echo $text['system_agent_ip'];?>:</div>
    <div class="row t2 border-bottom">
        <div class="col t2">
            <form id="agent_ip" style="margin: 3px 0px; margin-left: 10%" method="post">
                ...
                <input type="button" value="<?php echo $text['save'];?>" onclick="set_agent_ip()" class="all-btn w3-submit w3-border w3-round-large" style="float: right">
            </form>
        </div>
    </div>

    <div class="col t1" style="margin-left: 6%"><?php echo $text['system_agent_type'];?>:</div>
    <div class="row t2">
        <div class="col t2">
            <form id="agent_type_form"  method="post" style="margin: 3px 0px; margin-left: 9%">
                ...
                <input type="button" value="<?php echo $text['save'];?>" onclick="set_agent_type()" class="all-btn w3-submit w3-border w3-round-large" style="float: right">
            </form>
        </div>
        <div class="row">
            <div class="col t2" style="margin: 3px 0px; margin-left: 9%">
                <span><?php echo $text['system_client_status'];?>:<div id="c_status" style="display:inline-block;"></div></span>
