...
function include_css() {
    ...
    // 特例處理 - Dashboards 模組 - Tèlì chǔlǐ - Dashboards mó zǔ
...
?>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>css/select2.min.css?v=<?php echo ASSET_VERSION; ?>">
    ...
    <script src="<?php echo URLROOT; ?>js/select2.min.js?v=<?php echo ASSET_VERSION; ?>"></script>



    <!-- ================== 模組 JS 動態載入 ================== -->
    <?php 
    $modules = ['Inputs', 'Outputs', 'Jobs', 'Data', 'Sequences', 'Steps', 'Settings'];
