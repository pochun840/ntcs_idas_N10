...
class Controller
{
    ...
    public function Device_Info()
    {
        try {
            if (PHP_OS_FAMILY === 'Linux') {
                $db_path = '/var/www/html/database/ntcs_device.db';
            } else {
                $db_path = '../ntcs_device.db';
            }
    ...
    public function ntcs_data_db_sysnc() {
        $this->sync_db(
            ...
            '/var/www/html/database/ntcs_data2025.db'
        );
    ...
    public function ntcs_device_db_load() {
        $this->sync_db(
            '/home/kls/NTCS10/ntcs_device.db',
    ...
    public function sync_ntcs_tool_data() {
        $srcDB = '/home/kls/NTCS10/ntcs_device.db';
